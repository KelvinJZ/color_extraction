...
for c in list_color:
    if list_color.index(c) <= 5:
        ...
        ax2.add_patch(rect)
        ax2.text(x=x_posi + 400, y=y_posi + 100, s=c, fontsize=190)
    else:
        y_posi2 += 180
        rect = patches.Rectangle((x_posi + 1000, y_posi2), 360, 160, facecolor = c)
        ax2.add_artist(rect)
        ax2.text(x=x_posi + 1400, y=y_posi + 100, s=c, fontsize=190)
